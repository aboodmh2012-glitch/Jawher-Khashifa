...
class AmadeusSDKClient:
    ...
    def __init__(self, env):
        ...
        self.environment = self.config.get_param('fusion_travel.amadeus.environment', 'test')
        self.access_mode = self.config.get_param('fusion_travel.amadeus.access_mode', 'self_service')
        self.client_id = self.config.get_param('fusion_travel.amadeus.client_id')
        self.client_secret = self.config.get_param('fusion_travel.amadeus.client_secret')
        self.timeout = int(self.config.get_param('fusion_travel.amadeus.timeout', 45) or 45)
        self.debug_logging = self.config.get_param('fusion_travel.amadeus.debug_logging', 'False') in ('True', 'true', '1')
        self.base_url = (self.config.get_param('fusion_travel.amadeus.base_url') or '').strip() or None
        self._client = None
