...
class ResConfigSettings(models.TransientModel):
    ...
    trip_amadeus_client_id = fields.Char(
        ...
        config_parameter='trip.amadeus.client_id'
    )
    trip_amadeus_client_secret = fields.Char(
        string='Client Secret',
        config_parameter='trip.amadeus.client_secret'
    )
    trip_amadeus_token_url = fields.Char(
        string='OAuth Token URL Override',
        config_parameter='trip.amadeus.token_url',
    ...
    trip_amadeus_timeout = fields.Integer(
        ...
        default=45,
        config_parameter='trip.amadeus.timeout'
    )
    trip_amadeus_debug_logging = fields.Boolean(
        string='Store Full API Payloads',
        default=False,
        config_parameter='trip.amadeus.debug_logging',
    ...
    trip_amadeus_queuing_office_id = fields.Char(
        ...
        config_parameter='trip.amadeus.queuing_office_id',
    ...
    trip_default_country_calling_code = fields.Char(
        ...
        default='1',
        config_parameter='trip.default_country_calling_code',
    ...
    trip_travel_agent_email = fields.Char(
        ...
        config_parameter='trip.travel_agent_email',
